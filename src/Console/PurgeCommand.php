...
#[AsCommand(name: 'tokenable:purge')]
class PurgeCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'tokenable:purge
    ...
    public function handle(): void
    {
        ...
        tap(app(Authenticable::class), fn(Model $authorization) => $authorization
            ->newQuery()
            ...
            ->cursor()
            ->each(function (Model $authorizable) {
