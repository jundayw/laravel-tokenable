...
namespace Jundayw\Tokenable\Console;
...
class KeysCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'tokenable:keys
    ...
    public function handle(): int
    {
        [$publicKey, $privateKey] = [
            Tokenable::keyPath(config('tokenable.drivers.jwt.public_key', 'tokenable-public.key')),
            Tokenable::keyPath(config('tokenable.drivers.jwt.private_key', 'tokenable-private.key')),
        ];
