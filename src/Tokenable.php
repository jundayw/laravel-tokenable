...
use Jundayw\Tokenable\Models\Authentication;
...
class Tokenable
{
    ...
    /**
     * The authentication model class name.
     *
     * @var string
     */
    protected static string $authenticationModel = Authentication::class;

    /**
     * Set the authentication model class name.
     *
     * @param string $authenticationModel
     *
     * @return void
     */
    public static function useAuthenticationModel(string $authenticationModel): void
    {
        self::$authenticationModel = $authenticationModel;
    }

    /**
     * Get the authentication model class name.
     *
     * @return string
     */
    public static function authenticationModel(): string
    {
        return self::$authenticationModel;
    }
     ...
     * @return void
     */
    public static function useTokenRetrievalCallback(callable $callback = null): void
    {
